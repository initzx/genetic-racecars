...
default_map_config = MapConfig(
    ...
    checkpoints={
        ...
        'checkpoints': {
            0: {'coords': [(490, 183), (505, 66)], 'points': 50.0},
            1: {'coords': [(657, 238), (744, 204)], 'points': 50.0},
            2: {'coords': [(617, 421), (694, 526)], 'points': 50.0},
            3: {'coords': [(270, 510), (231, 594)], 'points': 50.0},
            4: {'coords': [(155, 320), (43, 300)], 'points': 50.0},
            5: {'coords': [(359, 294), (387, 223)], 'points': 50.0},
            6: {'coords': [(258, 230), (327, 191)], 'points': 50.0},
            7: {'coords': [(232, 178), (234, 70)], 'points': 50.0}
        }
    },
    spawn_point=(421, 115),
    pop_size=50,
